var View = (function () {
  ...
  function viewRestaurant(restaurant) {
    ...
    // console.log(restaurant);
      ...
      $('.view').append(`<h2><span class=‘address’>Address: ${restaurant.address1}</span>${restaurant.address2 ? restaurant.address2 : ''}<br> ${restaurant.city}, ${restaurant.state}  ${restaurant.zip_code}</h2> `);
      ...
      $('.view').append(`<br><a class="waves-effect waves-light btn" id='results-list'> \< Back to Results</a>`);
